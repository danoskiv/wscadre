	...
	if($hours == '1')
	{
		...
		{		
			...
			curl_setopt_array($curl, array(
			    ...
			    CURLOPT_URL => 'http://air.moepp.gov.mk/graphs/site/pages/MakeGraph.php?station=SkopjeRegion&parameter='.$parametri[$j].'&beginDate='.$beginDate.'&beginTime='. $beginHour .'&endDate='.$endDate.'&endTime='. $endHour .'&i=1521227934243&lang=en',
